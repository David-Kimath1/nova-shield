#!/usr/bin/env python3
"""Professional NOVA-SHIELD with Icons (No Emojis)"""
...
# Professional Scanner Page - No Emojis
SCANNER_PAGE = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
# Professional Bank Dashboard - No Emojis
BANK_PAGE = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * {
        ...
        .transactions-card { animation-delay: 0.2s; }
...
if __name__ == '__main__':
    print("="*50)
    print("NOVA-SHIELD PROFESSIONAL SYSTEM")
    print("="*50)
    print("URL: http://localhost:8080")
    print("Design: Clean professional interface")
    print("Icons: Text/SVG based (no emojis)")
    print("="*50)
